  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => GetMaterialApp(
        ...
        initialRoute: '/', // The initial route is correctly set to the home screen.
        getPages: [
          GetPage(name: '/', page: () => const HomeScreen()),
          GetPage(name: '/scientific', page: () => const BasicCalculatorScreen()),
        ...
        // The redundant 'home' property has been removed to prevent conflicts.
      ),
    );
  }
}
